...
public class CharacterEditor : ScriptableObject,IEditorToBytes
{
    ...
    [EnableIf("IsEditor")]
    public string FileName = "Sys_Character";
    ...
    public void CreateTextFile()
    {
        ...
        {
            sb.AppendFormat("ID:{0},名称:{1},头像:{2},职业ID:{3},等级:{4},生命值:{5},魔法值:{6},幸运值:{7}", CharacterInfos[i].characterId, CharacterInfos[i].characterName,
                CharacterInfos[i].characterProfile, CharacterInfos[i].classId, CharacterInfos[i].characterLevel,CharacterInfos[i].characterHp,CharacterInfos[i].characterMp,CharacterInfos[i].characterLuk);
            sb.Append("\n");
            sb.Append("战斗属性：");
...
public class CharacterInfo
{
    ...
    /// </summary>
    [FolderPath]
    public string characterProfile = "人物头像";
